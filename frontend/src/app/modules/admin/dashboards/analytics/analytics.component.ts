...
export class AnalyticsComponent implements OnInit, OnDestroy {
     ...
     */
    ngOnInit(): void {
        const url = `http://127.0.0.1:8000/api/metabase/7?type=dashboard`
        this.$iframeUrl = this.http.get<string>(url)
        //iframeUrl = METABASE_SITE_URL + "/embed/question/" + token + "#theme=transparent&bordered=true&titled=true";
