...
@Component({
    ...
    standalone: true,
    imports: [MatSidenavModule, NgFor, MatIconModule, NgClass, NgApexchartsModule, MatFormFieldModule, MatSelectModule, MatOptionModule, NgIf, FormsModule, MatInputModule, MatButtonModule, UpperCasePipe, DecimalPipe, CurrencyPipe, AsyncPipe, SafePipe],
})
export class CryptoComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        const url = `http://127.0.0.1:8000/api/metabase/5?type=dashboard`
